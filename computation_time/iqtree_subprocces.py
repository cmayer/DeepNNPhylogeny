...
for files in os.listdir(path_of_the_directory):
    if files.endswith(ext):
       if 'F81' in files:
           start = time.time()
           for i in range(1000):
               command = "iqtree2.1.3 -mset F81 -redo -s " + files
           ...
           start = time.time()
           for i in range(1000):
               command = "iqtree2.1.3 -mset F84 -redo -s " + files
               subprocess.run([command], shell=True)
           end = time.time()
           total_time = end - start
           f.write('File name: ')
           ...
           start = time.time()
           for i in range(1000):
               command = "iqtree2.1.3 -mset JC -redo -s " + files
               subprocess.run([command], shell=True)
           end = time.time()
           total_time = end - start
           f.write('File name: ')
           ...
           start = time.time()
           for i in range(1000):
               command = "iqtree2.1.3 -mset K2P -redo -s " + files
               subprocess.run([command], shell=True)
           end = time.time()
           total_time = end - start
           f.write('File name: ')
           ...
           start = time.time()
           for i in range(1000):
               command = "iqtree2.1.3 -mset GTR -redo -s " + files
               subprocess.run([command], shell=True)
           end = time.time()
           total_time = end - start
           f.write('File name: ')
           ...
           start = time.time()
           for i in range(1000):
               command = "iqtree2.1.3 -mset HKY -redo -s " + files
               subprocess.run([command], shell=True)
           end = time.time()
           total_time = end - start
           f.write('File name: ')
           ...
           start = time.time()
           for i in range(100):
               command = "iqtree2.1.3 -mset JTT -redo -s " + files
               subprocess.run([command], shell=True)
           end = time.time()
           total_time = end - start
           f.write('File name: ')
           ...
           start = time.time()
           for i in range(100):
               command = "iqtree2.1.3 -mset LG -redo -s " + files
               subprocess.run([command], shell=True)
           end = time.time()
           total_time = end - start
           f.write('File name: ')
           ...
           start = time.time()
           for i in range(1000):
               command = "iqtree2.1.3 -mset WAG -redo -s " + files
               subprocess.run([command], shell=True)
           end = time.time()
           total_time = end - start
           f.write('File name: ')
           ...
           start = time.time()
           for i in range(100):
               command = "iqtree2.1.3 -mset Dayhoff -redo -s " + files
               subprocess.run([command], shell=True)
           end = time.time()
           total_time = end - start
           f.write('File name: ')
