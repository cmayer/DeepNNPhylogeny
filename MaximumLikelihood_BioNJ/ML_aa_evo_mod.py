...
tmpdir = "/home/nkulikov/PycharmProjects/ML_NJ_iqtree/evo_mod/aa/"
...
def iqtree(sim_file):
    command =  'iqtree2.1.3 -mset JTT,LG,WAG,Dayhoff -mrate I,G,I+G -s ' + sim_file 
    ...
    elif letters[0:3] == 'WAG':
        topolog = 'WAG'

    elif letters[0:3] == 'Day':
        topolog = 'DAY'
            ...
            for i in base_models_choice_aa:
                for j in range(0, prediction_replicates):
                    if i == 'JTT':
                        ...
                        temporary_JTT.append(temporary)
                    if i == 'LG':
                    ...
                    if i == 'WAG':
                        temporary = simulate_random_lengths_random_free_model(0, 30000000 + j, base_models_choice_list,
                                                                            ...
                                                                            global_min_rrates_GTR,
                                                                            global_max_rrates_GTR, i)
                        temporary_WAG.append(temporary)
                    ...
                    if i == 'DAY':
                        temporary = simulate_random_lengths_random_free_model(0, 50000000 + j, base_models_choice_list,
                                                                            ...
                                                                            global_min_rrates_GTR,
                                                                            global_max_rrates_GTR, i)
                        temporary_DAY.append(temporary)
...
print('temporary_JTT: ', temporary_JTT)

print('temporary_LG: ', temporary_LG)

print('temporary_WAG: ', temporary_WAG)

print('temporary_DAY: ', temporary_DAY)
