...
tmpdir = "/home/nkulikov/PycharmProjects/ML_NJ_iqtree/norm_aa/"
...
#                break
        ...
        #                break
        print('letters', letters)
        if letters == '((AB)CD)' or letters == '(AB(CD))' or letters == '((AB)DC)' or letters == '(AB(DC))':  # '((AB)DC)' or letters == '(A(BC)D)' or letters == '(AB(CD))' or letters == '(AB(CD))' or letters == '((AC)BD)':
            topolog = 0
        elif letters == '((AC)BD)' or letters == '(AC(BD))' or letters == '(A(BD)C)' or letters == '(A(DB)C)':
            topolog = 1
        elif letters == '(A(BC)D)' or letters == '(A(CB)D)' or letters == '((AD)BC)' or letters == '(AD(BC))':  # letters == 'ACDB' or letters == 'ADCB':#or letters == ((AC)BD) :# letters == 'ADBC' :
            topolog = 2
